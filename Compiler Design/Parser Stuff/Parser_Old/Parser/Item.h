...
class Item {
	public:
		Item(string lhs, vector<string> rhs, int dotPos, int processNum,string state, int column, int row, const Item* Source, const Item* Partial);
		Item(string lhs, vector<string> rhs, int dotPos, int processNum, string state, int column, int row, const Item* Source);
